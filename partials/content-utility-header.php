...
<li><div class="header-cagov-logo"><a href="http://www.ca.gov/"  title="CA.gov"style="float: left;"><img src="<?php print get_stylesheet_directory_uri();?>/images/system/logo.svg" alt="Image of the CA.gov Logo"/></a></div></li>
